...
def build_charts(dataset: dict, period_df, x_: str) -> dict:
    ...
    fig_category_proportion_avgticket.add_vline(
    ...
    figures = {
        'fig_period_income': fig_period_income,
        'fig_period_orders_amt': fig_period_orders_amt,
        'fig_period_avgticket': fig_period_avgticket,
        'fig_product_rank_income': fig_product_rank_income,
        'fig_product_rank_orders_amt': fig_product_rank_orders_amt,
        'fig_product_rank_avgticket': fig_product_rank_avgticket,
        'fig_category_proportion_income': fig_category_proportion_income,
        'fig_category_proportion_orders_amt': fig_category_proportion_orders_amt,
        'fig_category_proportion_avgticket': fig_category_proportion_avgticket,
    }
    return figures